...
public class DeviceIpSlaStatsTask extends Task {

	private DeviceIpSlaStatsRequest request;

	public DeviceIpSlaStatsTask(DeviceIpSlaStatsRequest request) {
	...
	public void run() {
		...
		if(ping){
			...
			try{
				...
				SqlInsertableRowDescriptor stats = driver.getStats(request.getIpSla(), System.currentTimeMillis(), "Mock");
